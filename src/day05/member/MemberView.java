...
//    String menuNum = sc.nextLine();
    ...
    void signUp() {
        ...
        Member newMember = new Member(mr.getLastMemberId() + 1,
                email, password, name,
                gender, age);
        mr.addMembers(newMember);
...
//                System.out.println(mr.memberList[i].email);
//                if(mr.memberList[i].email.equals(inputEmail)){
//                    mr.memberList[i].inform();
//                }
//            }
    //찾은 회원의 정보
}
